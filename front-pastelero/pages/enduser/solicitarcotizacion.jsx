    ...
    <div>
      ...
      >
        ...
        <div class="flex items-center justify-center m-10">
          <label
            for="dropzone-file"
            class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100"
          >
        ...
        <div class=" bg-gray-200 rounded-full m-10">
          <div class="bg-primary text-xs font-medium text-text text-center p-0.5 leading-none rounded-full">
            {" "}
            45%
          </div>
        </div>
