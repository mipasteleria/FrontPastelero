      ...
      <div className="flex flex-col md:flex-row m-6">
        ...
        <div className="m-4 md:w-1/2">
          ...
          <input
            ...
            placeholder="0.0"
            {...register("budget", { required: "El presupuesto es obligatorio" })}
          />
        ...
        <div className="flex flex-col bg-rose-50 p-6 mb-6 rounded-lg">
          <div className="flex flex-col md:flex-row mb-6">
            ...
            <div className="m-4 md:w-1/2">
              ...
              <input
                ...
                {...register("userPhone", { required: "El número de celular es obligatorio" })}
              />
          ...
          <div className="m-4">
            ...
            <textarea
              ...
              rows="6"
              style={{ resize: "none" }}
              {...register("userComments", { required: "Este campo es obligatorio" })}
            />
