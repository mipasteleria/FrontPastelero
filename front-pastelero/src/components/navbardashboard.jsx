    ...
    <nav className={`bg-primary h-16 ${sofia.className} shadow-md z-50 sticky top-0`}>
      <div className="w-full flex flex-wrap items-center justify-between mx-auto">
        ...
        <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          ...
          <button data-collapse-toggle="navbar-user" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-white rounded-lg md:hidden hover:bg-secondary focus:outline-none focus:ring-2 focus:ring-white dark:text-gray-40 dark:hover:bg-gray-700 dark:focus:ring-gray-900" aria-controls="navbar-user" aria-expanded="false">
