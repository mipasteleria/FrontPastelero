...
const Asideadmin = () => {
  return (
    <aside
      id="default-sidebar"
      class="hidden md:flex top-16 left-0 md:w-1/4 h-grow transition-transform -translate-x-full sm:translate-x-0 min-h-screen"
      aria-label="Sidebar"
    >
      <div class="px-3 py-4 overflow-y-auto bg-primary dark:bg-gray-100">
        <ul class="space-y-2 font-medium">
          <Link href="/dashboard">
            <li>
              <Link
                href="/dashboard"
                class="flex items-center p-2 text-text rounded-lg dark:text-white hover:bg-white dark:hover:accent group"
              >
                <svg
                  class="w-5 h-5 text-text transition duration-75 dark:text-gray-400 group-hover:text-accent dark:group-hover:text-white"
                  aria-hidden="true"
          ...
          <Link href="/dashboard/usuarios">
            <li>
              ...
              >
                <svg
                  class="flex-shrink-0 w-5 h-5 text-text transition duration-75 dark:text-gray-400 group-hover:text-accent dark:group-hover:text-white"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 20 18"
                ...
                <span class="flex-1 ms-3 whitespace-nowrap text-text">
                  Usuarios
                </span>
              </Link>
            </li>
          ...
          <Link href="/dashboard/costeorecetas">
            <li>
              ...
              >
                ...
                <span class="flex-1 ms-2 whitespace-nowrap text-text">
                  Recetas
                </span>
